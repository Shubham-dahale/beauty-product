            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo Url::toRoute('contacts/index');?>"><i class="fa fa-plus-square fa-fw"></i>Contacts</a>
                        </li>
                        <!-- <li>
                       ...
                       <!--  <li>
                         ...
                         <li>
                            <a href="<?php echo Url::toRoute('sliders/index');?>"><i class="fa fa-scribd fa-fw"></i> Slider Images</a>
                        </li>
                        <li>
                            <a href="<?php echo Url::toRoute('sites/index');?>"><i class="fa fa-cogs fa-fw"></i> Site Settings</a>
                        </li>
                      <li>
                              <a href="<?php echo Url::toRoute('products/index');?>"><i class="fa fa-cogs fa-fw"></i> Product image</a>
                        </li>
                        <li>
                              <a href="<?php echo Url::toRoute('subproducts/index');?>"><i class="fa fa-cogs fa-fw"></i>Subproduct image</a>
                        </li>
